...
public class Login extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   Back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent I=new Intent(Login.this,Loadmode.class);
				startActivity(I);
...
//hint 
	...
	public class LoginAsync extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			Toast.makeText(getApplicationContext(), "Unsuccessful, Please check usernasme and password", Toast.LENGTH_LONG).show();
			}
	...
	//ÇáÑÞã ÇáãÊÛíÑ
		...
		public <T> String getFormParams(String html) throws Exception {
	       ...
	       // System.out.println(ids+" "+ns);
	        ...
	        Intent intent = new Intent(Login.this,CourseDetails.class);
			 
	        // pass array 
	        intent.putStringArrayListExtra("name",nameSorted);
	        intent.putStringArrayListExtra("iD", IDSorted);
	        intent.putStringArrayListExtra("sn", SNSorted);
